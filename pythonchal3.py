...
mess_text = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
...
less_mess_text = mess_text.replace('\n', '').replace('\r', '')
# print less_mess_text
word_list = re.findall(r'(?<![A-Z]{4})(?<=[A-Z]{3})([a-z])(?=[A-Z]{3})(?![A-Z]{4})', less_mess_text)
